...
vim.api.nvim_set_keymap('n', 'ca', '<cmd>lua vim.lsp.buf.code_action()<CR>', { noremap = true, silent = true , desc = "Code action"})
vim.api.nvim_set_keymap('n', '<leader>rf', '<cmd>Telescope lsp_references<CR>', { noremap = true, silent = true , desc = "References"})

vim.api.nvim_set_keymap('n', '<leader>dt', "<cmd>lua require'dap'.toggle_breakpoint()<CR>", { noremap = true, silent = true , desc = "Toggle breakpoint"})
